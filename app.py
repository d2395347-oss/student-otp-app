...
def submit():
    ...
    cursor.execute("""
        ...
        (name, father_name, date_of_birth, address, father_occupation, previous_institution_name, class_applied_for, category, phone_no, aadhaar_no, pan_no, special_file, extra_file, achievement_file, class_applied, status)
        VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)
    """, (name, father, category, phone, aadhaar_hash, file1_name, file2_name, file3_name, class_applied, status))
...
def students():
    ...
    cursor.execute("SELECT id, name, class_applied, status FROM students")
